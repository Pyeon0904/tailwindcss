export default function Spacing_Practice() {

  return (
    <>
      <main className='container mx-auto max-w-3xl p-4 space-y-8'>
        <div>
          <h2 className='text-2xl mb-2'>폰트 크기 조절</h2>
        ...
        <div>
          <h2 className='text-2xl mb-2'>폰트 두께 조절</h2>
        ...
        <div>
          <h2 className='text-2xl mb-2'>줄 간격</h2>
          ...
          <p className='leading-loose'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus debitis est
            fugit
        ...
        <div>
          <h2 className='text-2xl mb-2'>폰트 컬러 조절</h2>
        ...
        <div>
          <h2 className='text-2xl mb-2'>hover 추가</h2>
