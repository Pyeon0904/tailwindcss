export default function Responsive02Shop() {
  ...
  return (
    <>
      ...
      <main className="container max-w-5xl mx-auto px-4 pb-8 pt-24 flex gap-x-4 mb-[74px] sm:mb-0">
        ...
        <aside className="w-2/6 hidden sm:block">
          <div className="sticky top-16 p-6 border-2 border-gray-800 rounded-lg">
      ...
      <div className="block sm:hidden p-4 fixed bottom-0 left-0 right-0 bg-white border-t-2 border-gray-800">
        <button
